...
- **IPA Audio Visual** (https://hanna-hofmann.com/ipa-audio-visual/): Công cụ học Bảng Ký hiệu Ngữ âm Quốc tế (IPA) độc đáo sử dụng hình ảnh MRI thời gian thực được đồng bộ hóa với âm thanh. Bao gồm các phần về nguyên âm, phụ âm và giải phẫu, giúp người học hiểu rõ cách phát âm và cấu trúc âm thanh. Hữu ích cho việc cải thiện phát âm chính xác, học ngôn ngữ, giảng dạy, phiên âm, trị liệu ngôn ngữ, diễn xuất, ca hát và giao tiếp toàn cầu. Hai đặc điểm chính của IPA: mỗi ký hiệu chỉ đại diện cho một âm thanh duy nhất và hệ thống này bao quát tất cả các ngôn ngữ trên thế giới.
- **wav2vec 2.0** (https://arxiv.org/abs/2006.11477): Khung làm việc cho việc học biểu diễn giọng nói tự giám sát. Chứng minh lần đầu tiên rằng học các biểu diễn mạnh mẽ từ âm thanh giọng nói đơn thuần, sau đó tinh chỉnh trên dữ liệu được phiên âm, có thể vượt qua các phương pháp bán giám sát tốt nhất. Sử dụng kỹ thuật mask trong không gian latent và giải quyết tác vụ contrastive được định nghĩa trên quantization của các biểu diễn latent được học đồng thời. Đạt được 1.8/3.3 WER trên bộ test Librispeech clean/other. Khi giảm lượng dữ liệu có nhãn xuống một giờ, wav2vec 2.0 vượt qua state-of-the-art trước đó trên tập con 100 giờ trong khi sử dụng ít dữ liệu có nhãn hơn 100 lần. Chỉ sử dụng mười phút dữ liệu có nhãn và pre-training trên 53k giờ dữ liệu không gán nhãn vẫn đạt được 4.8/8.2 WER. Chứng minh tính khả thi của nhận dạng giọng nói với lượng dữ liệu có nhãn hạn chế.
- **CMUSphinx** (https://cmusphinx.github.io/): Bộ công cụ nhận dạng giọng nói mã nguồn mở, cung cấp các thư viện và công cụ để phát triển ứng dụng nhận dạng giọng nói. Bao gồm PocketSphinx (công cụ nhận dạng giọng nói nhẹ cho thiết bị di động và ứng dụng nhúng), SphinxTrain (bộ công cụ huấn luyện mô hình nhận dạng giọng nói), và Sphinx4 (thư viện Java). Hỗ trợ nhiều ngôn ngữ và cung cấp tài liệu hướng dẫn chi tiết. Cung cấp API cho C, Python và Java. Có thể cài đặt qua pip cho Python (`pip3 install pocketsphinx`). Phù hợp cho các ứng dụng thời gian thực và nghiên cứu nhận dạng giọng nói.
