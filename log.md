...
**Creation** English: thêm Skills section (Listening/Speaking/Reading Strategies, Paragraph And Essay Writing PEEL + essay types, Email And Letter Writing) + resource lists — Pronunciation/Resources (Minimal Pairs theo cặp âm, Silent Letters theo chữ cái), Vocabulary/Resources (Synonyms And Paraphrasing upgrade words, Idioms A To Z ~60 câu) + English/Resources/Learning Resources (sách, web, app theo từng kỹ năng)
**Creation** English: 3 section mới ngoài Grammar — Pronunciation (IPA And Phonemes 44 âm, Ending Sounds -ed/-s, Word Stress theo suffix, Sentence Stress And Intonation), Vocabulary (Collocations make/do/take, Confusable Words, Idioms And Expressions theo chủ đề, Topic Vocabulary), Usage (Formal And Informal English, Discourse Markers, British And American English) + Exam Skills (Common Errors của người học VN, Punctuation And Capitalization, Exam Question Types THPT); regenerate index.md
**Creation** English/Grammar/Concepts: 21 notes mới lấp đầy khoảng trống ngữ pháp — Verb Tenses (12 thì + tương lai + stative verbs), Conditional Sentences (loại 0-3, unless/provided/in case/otherwise/but for), Modal Verbs (+ perfect modals), Causative, Used To And Be Used To, Articles, Nouns (countable/uncountable, 's/of, compound), Pronouns, Quantifiers, Adjectives And Adverbs (OSASCOMP, -ed/-ing, so/such/too/enough), Comparisons, Prepositions (+ dependent preps), Conjunctions And Connectives, Noun Clauses, Participle Clauses, Subject Verb Agreement, Questions And Question Tags, Imperatives And Exclamations, There Be And It, Phrasal Verbs, Word Formation — tổng hợp từ chương trình SGK THPT (Global Success), English Grammar in Use (Murphy), và syllabus ôn thi THPTQG
**Update** Sentence Structure: condense phần conditional types thành link tới Conditional Sentences (theo convention giảm trùng lặp); Subjunctive Mood: thêm would rather / it's time / if only; Singular And Plural + English Roadmap: cross-link tới các note mới; regenerate Concepts/index.md
