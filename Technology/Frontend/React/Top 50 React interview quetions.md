...
2. Define the term Redux in React
...
3. What is the 'Store' feature in Redux?
...
5. Name the important features of React
...
6. Explain the term stateless components
...
9. What is meant by callback function? What is its purpose?
   ...
   function.
10. Explain the term high order component
...
16. What is React State?
    ...
    component.
17. How can you update state in react js?
    A state can be updated on the component directly or indirectly.
18. Explain the use of the arrow function in React
...
19. State the main difference between Pros and State
    The main difference the two is that the State is mutable and Pros are immutable.
20. Explain pure components in React js
...
21. What kind Of information controls a segment in React?
    There are mainly two sorts of information that control a segment: State and Props State: State information that will change, we need to utilize State.
...
30. Explain error boundaries?
    ...
    They are most used to log the error and show a fallback I-Jl.
31. What is the use of empty tags ?
    Empty tags are used in React for declaring fragments.
32. Explain strict mode
    StrictMode allows you to run checks and warnings for react components. It runs only on development build. It helps you to highlight the issues without rendering any visible IJI.
33. What are reacted portals?
    Portal allows you to render children into a DOM node. CreatePortalmethod is used for it.
34. What is Context?
    React context helps you to pass data using the tree of react components. It helps you tol share data globally between various react components.
35. What is the use of Webpack?
    ebpack in basically is a module builder. It is mainly runs during the development process.
...
47. Explain the term 'Restructuring.'
    Restructuring is extraction process of array objects. Once the process is completed, you I can separate each object in a separate variable.
