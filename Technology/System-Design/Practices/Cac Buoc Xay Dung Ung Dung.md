...
1. **Hiệu suất (Performance):** Tốc độ phản hồi, thời gian xử lý, và khả năng chịu tải.
2. **Khả năng mở rộng (Scalability):** Khả năng hệ thống mở rộng khi khối lượng công việc tăng.
3. **Khả năng bảo mật (Security):** Bảo vệ dữ liệu và ngăn chặn truy cập trái phép.
4. **Tính khả dụng (Availability):** Thời gian hệ thống sẵn sàng hoạt động.
