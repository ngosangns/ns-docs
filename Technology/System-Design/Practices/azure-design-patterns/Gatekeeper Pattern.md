...
description: Mẫu thiết kế Gatekeeper (Người gác cổng)
...
_Nguồn: [Azure Architecture Center - Gatekeeper pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/gatekeeper)_
