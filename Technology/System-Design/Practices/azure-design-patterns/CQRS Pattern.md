...
type: note
title: CQRS Pattern
description: Mẫu thiết kế CQRS (Command Query Responsibility Segregation)
...
_Nguồn: [Azure Architecture Center - CQRS pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/cqrs)_
