...
description: Mẫu thiết kế Competing Consumers (Người tiêu dùng cạnh tranh)
...
_Nguồn: [Azure Architecture Center - Competing Consumers pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/competing-consumers)_
