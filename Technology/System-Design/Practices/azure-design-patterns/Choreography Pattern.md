...
description: Mẫu thiết kế Choreography (Vũ đạo/Điều phối phân tán)
...
_Nguồn: [Azure Architecture Center - Choreography pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/choreography)_
