...
description: Mẫu thiết kế Deployment Stamps (Tem triển khai)
...
_Nguồn: [Azure Architecture Center - Deployment Stamps pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/deployment-stamp)_
