...
description: Mẫu thiết kế Gateway Aggregation (Gộp cổng)
...
_Nguồn: [Azure Architecture Center - Gateway Aggregation pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/gateway-aggregation)_
