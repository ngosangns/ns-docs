...
description: Mẫu thiết kế Asynchronous Request-Reply (Yêu cầu-Phản hồi bất đồng bộ)
...
_Nguồn: [Azure Architecture Center - Asynchronous Request-Reply pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/async-request-reply)_
