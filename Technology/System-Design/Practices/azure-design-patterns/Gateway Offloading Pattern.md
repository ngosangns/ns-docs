...
description: Mẫu thiết kế Gateway Offloading (Đẩy tải sang cổng)
...
_Nguồn: [Azure Architecture Center - Gateway Offloading pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/gateway-offloading)_
