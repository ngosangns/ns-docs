...
description: Mẫu thiết kế Claim-Check (Phiếu nhận hành lý)
...
_Nguồn: [Azure Architecture Center - Claim-Check pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/claim-check)_
