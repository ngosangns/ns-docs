...
- Hackernoon - The place to learn about the top technology, programming, web3, business, media, gaming, data science, finance, and cybersecurity stories from around the internet!: https://github.com/hackernoon/learn

### Research Resources

- List of important publications in computer science: http://taggedwiki.zubiaga.org/new_content/43dff2eb010d9dacdbaa8593ad40a2e6
...
- Make slider with markdown: https://github.com/slidevjs/slidev
- Write scripts with Javascript: https://github.com/google/zx
- OS backup tools: https://github.com/restic/restic
- Cross platform and multi-language SDK version manager: https://github.com/version-fox/vfox
- Convert các định dạng khác sang Markdown: https://github.com/microsoft/markitdown
...
- **Rustdesk**: An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer - [GitHub](https://github.com/rustdesk/rustdesk)
...
- **Hammerspoon**: Staggeringly powerful macOS desktop automation with Lua - [GitHub](https://github.com/Hammerspoon/hammerspoon)
