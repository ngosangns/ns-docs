...
type: guide
title: TikTok Like Recommender And AWS Personalize
description: Walkthrough of a TikTok-style two-tower recommender for H&M and an AWS Personalize plus Bedrock ad-copy solution, with a comparison of when to use each.
...
# TikTok Like Recommender And AWS Personalize
...
> **See also:** [Recommender Systems](/Technology/AI/Practices/Recommender Systems) · [AI Powered AB Testing With Amazon Bedrock](/Technology/AI/Write Ups/AI Powered AB Testing With Amazon Bedrock) · [KNN K Nearest Neighbors](/Technology/AI/Concepts/Core Concepts/KNN K Nearest Neighbors)
