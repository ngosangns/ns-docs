...
- **FLUX.1 Kontext**: Bộ mô hình generative flow matching với in-context image generation và editing capabilities (xem chi tiết ở section Image Generation Tools)
