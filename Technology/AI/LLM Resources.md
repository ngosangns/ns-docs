...
## 3.5. Diffusion Language Models

### 3.5.1. Tổng quan về Diffusion Language Models
...
- SFT model: [Dream-org/Dream-v0-Instruct-7B](https://huggingface.co/Dream-org/Dream-v0-Instruct-7B)
...
# 5. Vietnamese NLP Resources

- **Awesome Vietnamese NLP**: Danh sách tổng hợp các tài nguyên và công cụ liên quan đến Xử lý Ngôn ngữ Tự nhiên (NLP) cho tiếng Việt - [GitHub](https://github.com/vndee/awsome-vietnamese-nlp) #NLP #Vietnamese #resources
