...
- **S (Subject)** – Chủ ngữ: Danh từ, đại từ hoặc cụm danh từ.
- **V (Verb)** – Động từ: Động từ chính của câu.
- **O (Object)** – Tân ngữ: Tân ngữ trực tiếp (Direct Object - DO) hoặc gián tiếp (Indirect Object - IO).
...
S + V + O + O (Tân ngữ gián tiếp + Tân ngữ trực tiếp):
...
|                                     | Câu ghép                                               | Câu phức                                                                                      |
| ----------------------------------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| Thành phần                          | Chỉ gồm các mệnh đề độc lập                            | Gồm 1 mệnh đề độc lập + ít nhất 1 mệnh đề phụ thuộc                                           |
| Mệnh đề có đứng một mình được không | Có, mọi mệnh đề đều có nghĩa đầy đủ                    | Mệnh đề phụ thuộc không đứng một mình được                                                    |
| Công dụng                           | Diễn đạt hai hay nhiều ý có liên quan, ngang hàng nhau | Diễn đạt mối quan hệ giữa các ý (nguyên nhân - kết quả, điều kiện, thời gian, tương phản,...) |
...
- **Time:** _when, while, before, after, since, as soon as_
- **Reason:** _because, as, since_
- **Condition:** _if, unless, provided that_
- **Purpose:** _so that, in order that_
