...
- **Cấu trúc:** 4 phần (Parts), mỗi phần 10 câu → **tổng 40 câu**.
  - **Part 1:** Hội thoại 2 người trong bối cảnh đời sống thường ngày (vd: đặt phòng, hỏi thông tin du lịch).
  - **Part 2:** Độc thoại (monologue) trong bối cảnh đời sống thường ngày (vd: giới thiệu tiện ích cộng đồng).
  - **Part 3:** Hội thoại (lên đến 4 người) trong bối cảnh giáo dục/đào tạo (vd: giảng viên và sinh viên thảo luận bài tập).
  - **Part 4:** Độc thoại học thuật (vd: bài giảng đại học).
- **Giọng đọc:** đa dạng accent — British, Australian, New Zealand, North American.
- **Dạng câu hỏi:** multiple choice, matching, điền vào bản đồ/sơ đồ, điền form/bảng/flow-chart, hoàn thành câu, trả lời ngắn — có giới hạn số từ.
- **Chấm điểm:** mỗi câu đúng 1 điểm → quy đổi ra band 1-9.
...
- **Nguồn văn bản:** trích từ sách, tạp chí, báo, tài liệu học thuật — không yêu cầu kiến thức chuyên ngành trước.
- **Dạng câu hỏi (11 dạng):** multiple choice; True/False/Not Given; Yes/No/Not Given; matching information; matching headings; matching features; matching sentence endings; sentence completion; summary/note/table/flow-chart completion; diagram label completion; short-answer questions.
- **Chấm điểm:** mỗi câu đúng 1 điểm → quy đổi ra band 1-9.

Nguồn: [IELTS Academic Reading format](https://ielts.org/take-a-test/test-types/ielts-academic-test/ielts-academic-format-reading).
...
- **Quản lý thời gian Reading:** ~20 phút/đoạn văn (bao gồm cả điền đáp án), không sa đà vào 1 câu khó.
