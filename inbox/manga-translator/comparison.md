...
Bảng so sánh các tool dịch manga/comic mã nguồn mở, xếp theo stars (phổ biến).

## Bảng so sánh chính

| #   | Tool                                                                                       | Stars | Ngôn ngữ   | License    | Platform    | Input Formats          | Inpainting                     | OCR                            | Translation                                                  |
| --- | ------------------------------------------------------------------------------------------ | ----- | ---------- | ---------- | ----------- | ---------------------- | ------------------------------ | ------------------------------ | ------------------------------------------------------------ |
...
| Tool                      | OS              | GUI Framework | Đặc điểm nổi bật                   |
| ------------------------- | --------------- | ------------- | ---------------------------------- |
...
| Tool                            | Platform | Đặc điểm nổi bật                    |
| ------------------------------- | -------- | ----------------------------------- |
...
## Phân loại theo Translation Method
...
1. **cotrans** - Web-based, không cần install
...
- Xem chi tiết từng tool trong các file memory riêng: `manga-image-translator.md`, `koharu.md`, `comic-translate.md`, `cotrans.md`, `tachiyomi-at.md`
